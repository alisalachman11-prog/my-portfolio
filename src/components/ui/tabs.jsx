...
const tabsListVariants = cva(
  "group/tabs-list inline-flex w-fit items-center justify-center rounded-lg p-[10px] text-muted-foreground group-data-horizontal/tabs:h-14 group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col data-[variant=line]:rounded-none",
  {
    variants: {
      variant: {
        default: "bg-muted",
...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      ...
      className={cn(tabsListVariants({ variant }), className=  "w-full")}
